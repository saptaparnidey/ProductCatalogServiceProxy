...
(
    id           BIGINT NOT NULL,
    num_of_hours VARCHAR(255) NULL,
    CONSTRAINT pk_jc_mentor PRIMARY KEY (id)
);
...
(
    ...
    CONSTRAINT pk_jc_ta PRIMARY KEY (id)
);
...
ALTER TABLE jc_mentor
    ADD CONSTRAINT FK_JC_MENTOR_ON_ID FOREIGN KEY (id) REFERENCES jc_user (id);

ALTER TABLE jc_ta
    ADD CONSTRAINT FK_JC_TA_ON_ID FOREIGN KEY (id) REFERENCES jc_user (id);
